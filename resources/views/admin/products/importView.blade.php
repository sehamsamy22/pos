    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="btn-group pull-right m-t-15">
                <a href="{{route('dashboard.products.index')}}" class="btn btn-custom dropdown-toggle waves-effect waves-light" >رجوع لإدارة المنتجات والوجبات<span class="m-l-5"><i class="fa fa-reply"></i></span></a>
            </div>
            <h4 class="page-title">رفع وجبات جديدة</h4>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    ...
                    {!!Form::open( ['route' => 'dashboard.products.importMeal' ,'class'=>'form phone_validate', 'method' => 'Post','files' => true,'id'=>'form']) !!}
