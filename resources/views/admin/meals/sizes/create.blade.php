    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="btn-group pull-right m-t-15">
                <a href="{{route('dashboard.sizes.show',$meal->id)}}" class="btn btn-custom dropdown-toggle waves-effect waves-light" >رجوع للاحجام   <span class="m-l-5"><i class="fa fa-reply"></i></span></a>
            </div>
